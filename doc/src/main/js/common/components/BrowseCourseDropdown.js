...
module.exports = React.createClass({
	...
	render: function() {
		return (
			React.DOM.div( {id:"drop2", 'data-dropdown-content':true, className:"medium f-dropdown content"}, 
				React.DOM.ul( {className:"large small-block-grid-2 medium-block-grid-3 large-block-grid-3"}, 
