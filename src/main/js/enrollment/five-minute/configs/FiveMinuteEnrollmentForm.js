...
const t = scoped('enrollment.forms.fiveminute', {
	...
	historyEnrollViaOzone:
		'Please sign up for the course using your <a href="http://ozone.ou.edu" target="_blank">Ozone</a> account. Note: not all Janux courses are available for credit to OU students.',
		...
		fields: [
			{
				...
				predicateFunc(value) {
					...
					return (
						isSameDay(thirteenYearsAgo, value) ||
						isAfter(thirteenYearsAgo, value)
					);
				},
				ifTrue: [
					{
