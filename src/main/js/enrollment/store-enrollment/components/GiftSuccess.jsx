...
export default class extends React.Component {
	...
	render() {
		...
		const { receiver, sender, redemptionCode, transactionID } =
			purchaseattempt || {};
		...
		return (
			<div className="gift-success">
				...
				<div className="panel">
					...
					<div
						className="gift"
						{...rawContent(t(infoKey, { sender, receiver }))}
					/>
				...
				<div className="actions">
					<Button onClick={this.onNewGift}>
						Purchase another Gift
					</Button>
					<Button onClick={onDone} href={doneLink}>
						I’m done
					</Button>
				</div>
			</div>
