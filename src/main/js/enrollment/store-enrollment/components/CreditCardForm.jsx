...
class CreditCardForm extends React.Component {
	...
	render() {
		...
		return (
			<fieldset
				className={cx('credit-card-form', className)}
				{...(errors || {})}
			>
				...
				/>
				{errors && (
					<div className="error-message">{t('requiredField')}</div>
				)}
			</fieldset>
		);
	}
...
export default decorate(CreditCardForm, [mixin(ExternalLibraryManager)]);
