...
const t = scoped('enrollment.confirmation', {
	...
	review:
		'Please take a moment to review your order and submit your payment.',
...
export default createReactClass({
	...
	attachSubscribeCheckboxRef(x) {
		this.subscribeToUpdates = x;
	},
	...
	submitPayment(event) {
		...
		const {
			state: { couponInfo, giftInfo, stripeToken },
		} = this;
	...
	render() {
		const {
			props: { purchasable },
			state: { busy, stripeToken, giftInfo },
		} = this;
				...
				{busy || !stripeToken ? (
					...
					<div>
						...
						>
							...
							<p>
								Clicking submit will charge your card{' '}
								{this.getPrice()}
								{isGift ? '' : ' and enroll you in the course'}.
							</p>
								...
								<div className="subscribe">
									<label>
										<input
											type="checkbox"
											ref={
												this.attachSubscribeCheckboxRef
											}
											name="subscribe"
										/>
