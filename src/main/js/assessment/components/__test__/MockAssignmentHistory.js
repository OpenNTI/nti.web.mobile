...
const HistoryItemContainer = getModel(
	'assessment.userscourseassignmenthistoryitemcontainer'
);

export default function MockAssignmentHistory(
	created = new Date(),
	submitted = true,
	excused = false
) {
	const proto = {
		...
		getMostRecentHistoryItem: () => {
			return {
				MimeType:
					'application/vnd.nextthought.assessment.assignmenthistoryitem',
