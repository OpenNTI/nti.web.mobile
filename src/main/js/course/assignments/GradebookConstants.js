export const FILTER_CHANGED = Symbol('gradebook:FILTER_CHANGED');
export const GRADEBOOK_BY_ASSIGNMENT_LOAD_BEGIN = Symbol('gradebook:GRADEBOOK_BY_ASSIGNMENT_LOAD_BEGIN');
export const GRADEBOOK_BY_ASSIGNMENT_LOADED = Symbol('gradebook:GRADEBOOK_BY_ASSIGNMENT_LOADED');
